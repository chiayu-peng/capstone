...
**Feature Description**
  ...
  - **Financial Stress**: A measure of the stress experienced due to financial concerns, which may affect mental health. 1-
...
It should NOT be used as a standalone clinical diagnostic tool.
